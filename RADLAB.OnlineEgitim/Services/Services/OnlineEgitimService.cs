...
namespace RADLAB.OnlineEgitim.Services.Services
{
    public class OnlineEgitimService : IOnlineEgitimService
    {
        ...
        public async Task<ServiceResponse<string>> UpdateOnlineEgitimBolumTamamlananVideoTime(OnlineEgitimBolumTamamlananDTO dto)
        {
            var result = await httpClient.PostAsJsonAsync("OnlineEgitim/UpdateOnlineEgitimBolumTamamlananVideoTime", dto);
