...
namespace RADLAB.OnlineEgitim.Services.Infrastructure
{
    public interface IOnlineEgitimService
    {
        ...
        public Task<ServiceResponse<List<OnlineEgitimSonucDTO>>> GetOnlineEgitimSonucList(int OnlineEgitimId);
        public Task<ServiceResponse<string>> UpdateOnlineEgitimBolumTamamlananVideoTime(OnlineEgitimBolumTamamlananDTO dto);
    }
}